...
sudo chmod +x /usr/local/bin/backup_inteligente.sh
sudo chmod +x /usr/local/bin/setup_rsnapshot.sh
sudo chmod +x /usr/local/bin/restaurar_backup.sh
...
www-data ALL=(root) NOPASSWD: /usr/local/bin/restaurar_backup.sh
